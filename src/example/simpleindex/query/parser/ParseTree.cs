...
namespace bsharptree.example.simpleindex.query.parser
{
    ...
    public partial class ParseNode
    {
        ...
        internal object Eval(ParseTree tree, params object[] paramlist)
        {
            ...
            switch (Token.Type)
            {
                ...
                case TokenType.MustClause:
                    Value = EvalMustClause(tree, paramlist);
                    break;
                case TokenType.MustNotClause:
                    Value = EvalMustNotClause(tree, paramlist);
                    break;
                case TokenType.Clause:
                    Value = EvalClause(tree, paramlist);
                    break;
                case TokenType.SubClause:
                    Value = EvalSubClause(tree, paramlist);
                    break;
                case TokenType.Term:
                    Value = EvalTerm(tree, paramlist);
                    break;
        ...
        protected virtual object EvalMustClause(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalMustNotClause(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalClause(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }

        protected virtual object EvalSubClause(ParseTree tree, params object[] paramlist)
        {
            throw new NotImplementedException();
        }
